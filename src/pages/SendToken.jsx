...
const SendToken = () => {
  const { signedAccountId, wallet, accountBalance } = useContext(NearContext);
  ...
  useEffect(() => {
    ...
    const transaction = params.get("transactionHashes");
  ...
  return (
    <>
      ...
      <div className="container mx-auto animate__animated animate__fadeIn  w-full px-5 py-10   items-center">
        <div className="pb-10 ">
            ...
            isSubmitting ? (
              ...
              <>
                <div className="py-4 text-gray-600">
                  <p className="text-center">Estimated Balance</p>
