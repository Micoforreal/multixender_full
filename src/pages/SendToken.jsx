...
import { DivideCircle, Plus, RefreshCcw, Target, Watch, X } from "lucide-react";
                  ...
                  <div className="flex  md:ps-0 ps-5 ">
                    ...
                    <div className="font-semibold  md:text-base text-sm">
                      <p className="flex py-1">
                        Gas Fee <span className="float-end px-5">${fees.gasFee}</span>
                      </p>

                      <p className=" flex py-1">
                        Total <span className="float-end px-10">${fees.total}</span>
                      </p>
                    </div>
